...
export default function HomePage() {
  return (
    <LocationProvider>
    <div className="bg-landing-dark text-landing-cream">
      ...
      <section className="relative flex h-[calc(100dvh-6rem)] min-h-[480px] items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-landing-dark via-[rgba(10,6,4,0.4)] to-[rgba(10,6,4,0.55)]" />

        <div className="relative z-10 flex flex-col items-center gap-6 px-4 text-center">
          {/* Eyebrow text */}
          <p className="font-mono text-[0.62rem] tracking-[0.45em] uppercase text-landing-brown">
            CLASSIFIED · MEMBERS ONLY · EST. 2024
          </p>

          {/* Main title with neon glow */}
          <h1 className="font-display text-[clamp(3.8rem,10vw,8rem)] font-light leading-[1.05] tracking-tight text-landing-cream">
            <span className="text-landing-amber text-neon-glow animate-flicker">Discover</span>
            <br />
            <em className="italic">Hidden Bars</em>
          </h1>

          {/* Subtitle */}
          <p className="mt-2 text-lg text-landing-tan">
        ...
        <div className="absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-2">
          <span className="animate-scroll-pulse font-mono text-[9px] tracking-[0.3em] text-landing-tan">
            SCROLL
          </span>
          <div className="h-8 w-px bg-gradient-to-b from-landing-brown to-transparent" />
        </div>
      </section>
